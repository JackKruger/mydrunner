...
- `packages/client/src/scene.ts` — snapshot interpolation (remote) + owner override (local), per-player visuals, mud particles and minimap. It exports the exact drawn remote chassis poses for collision proxies.
