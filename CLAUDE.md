...
- `packages/shared/src/physics/tire.ts` / `tireCarcass.ts` — live longitudinal/lateral slip curves, force relaxation, load sensitivity, friction-ellipse combination, compliant carcass force, and pressure scaling. Launch and hill holding blend to a bounded static constraint below 0.5 m/s.
